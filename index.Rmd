...
```{r caribou-trend, fig.cap="Monthly number of Caribou been tracked between 1988 to 2016", fig.align= "center"}
...
```{r caribou-map, fig.width=15, fig.height=20}
ggmap(caribou_map) +
