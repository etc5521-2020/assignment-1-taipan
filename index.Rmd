...
The data set tracks woodland caribou in northern British Columbia published by the Movebank Data Repository at https://www.datarepository.movebank.org/handle/10255/move.955. This data was collected by putting trackers of almost 250,000 location tags on 260 caribou, from 1988 to 2016, which was accessed through Movebank. 
...
This set of data is primarily used to analyse the changes in the number of caribou from 1988 to 2016 to observe the survival of the species. Is also can be used for further analysis, including:
- From the location data using location and date variables to analysis, the varies of these habitats by seasonally (summer and winter).
- According to the  Peace Northern, Caribou Plan endorsed in  November 2012. The goal is to increase the South Peace Northern Caribou to 1,200 animals within 21 years.  By using the data sets we can analyse whether the trend of the number of animals is increasing in the previous years, and also is it possible to achieve the in 2032
- By analysing the classification of tag deployment end to decide whether the management plan is efficient to increase the number of caribou and whether they have to modify the tracking method, such as if there is a large proportion of tag deployment end due to the equipment failure, they have to decide to improve the quality of the tag
