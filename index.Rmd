...
```
(add the text showing the number in text)

It can be seen from figure () that out of all the deploy_off_type stated in the description, there are only four types available in the dataset, which are dead, removal, other and unknown. The highest number of ... is unknown, which indicates that there was no proper tracking and documentation. 
